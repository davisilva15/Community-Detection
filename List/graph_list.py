			...
			if p == 1:
				for a in range(1, n1):
					for b in range(a + 1, n1 + 1):
						...
						self.adj_list[shift1 + a].append(shift1 + b)
						self.adj_list[shift1 + b].append(shift1 + a)
			...
			if p == 1:
				for a in range(1, n1 + 1):
					for b in range(1, n2 + 1):
						...
						self.adj_list[shift1 + a].append(shift2 + b)
						self.adj_list[shift2 + b].append(shift1 + a)
